							...
							<ul class="navbar-nav ml-auto">
                                <li class="nav-item pl-4 m-auto">
                                    <form class="form-inline search">
                                        ...
                                        <button class="btn btn-outline-success" type="submit"><font-awesome-icon icon="search" size="2x" /></button>
                                    </form>
                                </li>
								...
								<li class="nav-item pl-4 my-auto pl-md-0 ml-0 ml-md-4">
									<a class="nav-link" href="#"><font-awesome-icon icon="shopping-cart" size="2x" /></a>
								</li>
                                <li class="nav-item pl-4 my-auto pl-md-0 ml-0 ml-md-4">
									<a class="nav-link" href="#"><font-awesome-icon icon="user" size="2x" /></a>
								</li>
							</ul>
						</div>						
					</nav>		
...
.navigation-wrap a:hover, .navigation-wrap .bar:hover {
  color: #3b1c15;
  transition: all 0.5s;
}
